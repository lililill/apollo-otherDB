...
public class NamespaceService {
    ...
    public void deleteNamespace(String appId, Env env, String clusterName, String namespaceName) {
        ...
        if (appNamespace != null && appNamespace.isPublic() == 1 && publicAppNamespaceHasAssociatedNamespace(
                namespaceName, env)) {
            throw new BadRequestException(
    ...
    private void fillAppNamespaceProperties(NamespaceBO namespace) {
        ...
        if (appNamespace == null) {
            ...
            isPublic = 1; // set to true, because public namespace allowed to delete by user
        } else {
