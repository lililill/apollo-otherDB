...
public interface UserRoleRepository extends PagingAndSortingRepository<UserRole, Long> {
  ...
  @Modifying
  @Query(nativeQuery = true, value ="UPDATE \"UserRole\" SET \"IsDeleted\" = true, \"DeletedAt\" = ROUND(extract (epoch from now())), \"DataChange_LastModifiedBy\" = ?2 WHERE \"RoleId\" in ?1 and \"IsDeleted\" = false")
