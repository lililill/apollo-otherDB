...
public interface ItemRepository extends PagingAndSortingRepository<Item, Long> {
  ...
  @Modifying
  @Query(nativeQuery = true, value ="update \"Item\" set \"IsDeleted\" = true, \"DeletedAt\" = ROUND(extract (epoch from now())), \"DataChange_LastModifiedBy\" = ?2 where \"NamespaceId\" = ?1 and \"IsDeleted\" = false")
