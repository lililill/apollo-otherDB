...
cd ..
#docker build  . -t apollo-adminservice-kingbase8-pg:2.2.0 --platform linux/arm64
docker build  . -t apollo-adminservice-kingbase8-pg:2.2.0
...
cd ..
docker build . -t apollo-configservice-kingbase8-pg:2.2.0
#docker build . -t apollo-configservice-kingbase8-pg:2.2.0 --platform linux/arm64
...
cd ..
docker build . -t apollo-portal-kingbase8-pg:2.2.0
#docker build . -t apollo-portal-kingbase8-pg:2.2.0 --platform linux/arm64
...
docker save -o ./apollo-configservice-kingbase8-pg.tar apollo-configservice-kingbase8-pg:2.2.0
docker save -o ./apollo-adminservice-kingbase8-pg.tar apollo-adminservice-kingbase8-pg:2.2.0



#docker run -p 8090:8090 \
#    -e SPRING_DATASOURCE_URL="jdbc:kingbase8://192.168.1.176:54321/apolloconfigdb-pg" \
#    -e SPRING_DATASOURCE_USERNAME=system -e SPRING_DATASOURCE_PASSWORD=Tomtaw001 \
#    -d -v /tmp/logs:/opt/logs --name apollo-adminservice apollo-adminservice-kingbase8-pg:2.2.0
#
#docker run -p 8080:8080 \
#    -e SPRING_DATASOURCE_URL="jdbc:kingbase8://192.168.1.176:54321/apolloconfigdb-pg" \
#    -e SPRING_DATASOURCE_USERNAME=system -e SPRING_DATASOURCE_PASSWORD=Tomtaw001 \
#    -d -v /tmp/logs:/opt/logs --name apollo-configservice apollo-configservice-kingbase8-pg:2.2.0
#
#
#docker run -p 8070:8070 \
#    -e SPRING_DATASOURCE_URL="jdbc:kingbase8://192.168.1.176:54321/apolloportaldb-pg" \
#    -e SPRING_DATASOURCE_USERNAME=system -e SPRING_DATASOURCE_PASSWORD=Tomtaw001 \
#    -e APOLLO_PORTAL_ENVS=dev,pro \
#    -e DEV_META=http://192.168.1.152:8080 -e PRO_META=http://192.168.1.152:8080 \
#    -d -v /tmp/logs:/opt/logs --name apollo-portal apollo-portal-kingbase8-pg:2.2.0